...
async function createStudentWithTimetable() {
  ...
  try {
    ...
    let teacherDoc = await db.collection('teachers').findOne({ role: 'TEACHER' });
    if (!teacherDoc) {
    ...
    console.log('========================================');
    console.log('STUDENT CREATED WITH TIMETABLE DATA');
    console.log('========================================');
    console.log('');
...
createStudentWithTimetable().catch(console.error);
