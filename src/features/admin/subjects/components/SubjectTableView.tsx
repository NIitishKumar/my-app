/**
 * SubjectTableView Component - Read-only version
 */
...
interface SubjectTableViewProps {
  subjects: Subject[];
  onView?: (subject: Subject) => void;
}

export const SubjectTableView = ({ subjects, onView }: SubjectTableViewProps) => {
  ...
  if (subjects.length === 0) {
    return (
      <div className="p-6 text-center text-gray-500">
        ...
        <p className="text-xs text-gray-500 mt-1">No subjects available at this time</p>
      </div>
    );
  }
