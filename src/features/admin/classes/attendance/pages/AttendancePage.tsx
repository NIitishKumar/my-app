 ...
 * Full-page attendance management
 */
...
export const AttendancePage = () => {
  ...
  const { data: classData, isLoading: isLoadingClass, error: classError } = useClassDetails(id || '');
  ...
  const handleFormSuccess = () => {
    ...
    // Clear URL params
    navigate(`/admin/classes/${id}/attendance`, { replace: true });
  };

  const handleEditRecord = (record: AttendanceRecord) => {
    setEditingRecord(record);
    setActiveTab('mark');
    navigate(`/admin/classes/${id}/attendance?record=${record.id}`, { replace: true });
  };
