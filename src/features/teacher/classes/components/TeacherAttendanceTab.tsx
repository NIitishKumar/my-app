/**
 * TeacherAttendanceTab Component
 * Attendance tab for teacher class detail page
 */

import { useState } from 'react';
import { useNavigate } from 'react-router-dom';
import { useClassAttendance } from '../../../admin/classes/attendance/hooks/useClassAttendance';
import { useAttendanceStats } from '../../../admin/classes/attendance/hooks/useAttendanceStats';
...
export const TeacherAttendanceTab = ({ classId }: TeacherAttendanceTabProps) => {
  ...
  const handleMarkAttendance = () => {
    navigate(`/teacher/classes/${classId}/attendance?action=mark`);
  };
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center justify-between">
                        ...
                        <button
                          onClick={() => navigate(`/teacher/classes/${classId}/attendance?record=${record.id}`)}
